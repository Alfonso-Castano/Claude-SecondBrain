...
- "Grill me" — a standing interrogation tool/skill used for both initial knowledge extraction and reconciliation interrogation, adapted from existing proven skills (e.g. the `superpowers` repo) rather than built from scratch
